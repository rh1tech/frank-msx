...
/* Pico port: no dirent / direct; dir-scan code paths aren't wired. */
#else
#include <direct.h>
#endif

/* Route disk-image buffers to PSRAM — a single 720 kB MSX disk does not
 * fit in the 520 kB SRAM heap on RP2350. */
